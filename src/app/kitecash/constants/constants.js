...
exports.Constants = {
    ...
    URL: {
        LOGIN: environment_1.environment.serverUrl + '/login',
        LOGOUT: environment_1.environment.serverUrl + '/logout',
        CHANGE_PASSWORD: environment_1.environment.serverUrl + '/changePassword',
        MANUAL_REFUND: environment_1.environment.serverUrl + '/initiate/manualrefund'
    },
    Images: {
